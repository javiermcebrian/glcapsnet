...
lr = 0.0001
lr_decay = 0.99
batch_size = 32  # single-feature: 32. multi-feature: 8
epochs = 50
initial_epoch = 0
...
data_augmentation_config = {
    'rate': 0.6,  # Probability of appling augmentation to sample
    'crop': {
        'resize_ratio_params': {'low': 1, 'high': 2},
        'slack_ratio': 1  # From tight to center (0) to all search space (1)
    },
    'mirror': {'prob': 0.5}  # Mirror along W axis
}
...
pretrain_config = [
    'path_to_pretrained_weights_vgg.h5',
]
fusion_config = []
capsnet_config = {
